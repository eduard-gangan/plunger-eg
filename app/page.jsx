			...
			gsap.to(model.current, {
				scrollTrigger: {
					...
					onUpdate: ({ progress }) => {
						...
						setposition([-2, 1 - progress, 0]);
						if (window.innerWidth < 768) {
							setscale(20 - progress * 10);
						} else {
							setscale(30 - progress * 15);
						}
					},
				},
			});
		...
		>
			...
			>
				...
				<ul className="absolute justify-self-end even:*:text-zinc-600 odd:*:text-zinc-800 text-3xl list-disc grid gap-2 font-heading m-8">
					<li>Unclog toilets</li>
					<li>Open wine bottles</li>
					<li>Mash potatoes</li>
					<li>Stylish hat</li>
					<li>Go fishing</li>
					<li>Scoop ice-cream</li>
					<li>Beat your sister</li>
				</ul>
			</section>
			<section
				id="section3"
			...
			>
				<div className="absolute max-w-80 text-lg text-zinc-700 left-1/3 top-36 before:absolute before:content-['1'] before:text-10xl before:-left-20 before:top-4 before:font-heading before:text-zinc-400/50 z-10 before:-z-10">
					The plunger's suction cup grips any surface with incredible strength,
					tackling clogs effortlessly every time.
				</div>
				<div className="absolute max-w-80 text-lg text-zinc-700 right-[20%] top-80 before:absolute before:content-['2'] before:text-10xl before:-left-28 before:top-4 before:font-heading before:text-zinc-400/50 z-10 before:-z-10">
					Crafted precisely, the suction cup forms an airtight seal, ensuring
					efficiency on all surfaces.
				</div>
				<div className="absolute max-w-80 text-lg text-zinc-700 right-24 top-132 before:absolute before:content-['3'] before:text-10xl before:-left-24 before:font-heading before:text-zinc-400/50 z-10 before:-z-10">
			...
			>
				...
				<div className="absolute left-1/2 -translate-x-1/2 bottom-32 text-lg text-zinc-500">
					( Banana for scale )
				</div>
			</section>
		</main>
